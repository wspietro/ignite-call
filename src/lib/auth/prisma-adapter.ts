  ...
  return {
    async createUser(user) {
      ...
      return {
        ...
        email: prismaUser.email!, // ts não sabe que o método só será chamado após o user ser criado
        emailVerified: null,
        avatar_url: prismaUser.avatar_url!,
      }
    }, // usuário já foi criado, iremos buscar o id nos cookies e atualizar o registro do user
    ...
    // usuário faz login com novo provider
