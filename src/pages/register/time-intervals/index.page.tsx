...
type TimeIntervalsFormOutput = z.output<typeof timeIntervalFormSchema> // depois das transformações
...
export default function TimeIntervals() {
  ...
  // Permite iterar um campo do formulário que é um array, que pode receber mais ou menos valores
  // Dinâmico
  ...
  async function handleSetTimeIntervals(data: any) {
    const { intervals } = data as TimeIntervalsFormOutput // issue comentado na última linha
...
// cada dia da semana será registrado como um item dentro do array
// chamamos isso no react-hook-form de Field Arrays.
